...
"""
tests individually validate the different components of coolvib.
At the moment this is not a complete or automated test suite, but 
it should be one at some point
"""
