...
for index in range(1,num_plots):
    x = np.loadtxt('excit_scan_kpoints_all_{0}.txt'.format(index),usecols=range(0,1))
    y = np.loadtxt('excit_scan_kpoints_all_{0}.txt'.format(index),usecols=range(1,2))
